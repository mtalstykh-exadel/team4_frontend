...
export const TestLevelSelector = () => {
  ...
  const testLevelsDataEN = [
    {
      id: 101,
      titleEN: 'Survival Level — Beginner и Elementary (A1)',
      ...
      titleRU: 'Уровень выживания - начальный и элементарный (A1)',
    ...
    {
      id: 102,
      titleEN: 'Waystage — Pre-Intermediate (A2)',
      ...
      titleRU: 'Waystage - Уровень ниже среднего (A2)',
    ...
    {
      id: 103,
      titleEN: 'Threshold — Intermediate (B1)',
    ...
    {
      id: 104,
      titleEN: 'Vantage — Upper-Intermediate (B2)',
      ...
      titleRU: 'Vantage - выше среднего (B2)',
    ...
    {
      id: 105,
      titleEN: 'Effective Operational Proficiency — Advanced (C1)',
      ...
      titleRU: 'Эффективные операционные навыки - Продвинутый (C1)',
    ...
    {
      id: 106,
      titleEN: 'Mastery — Proficiency (C2)',
  ...
  const testLevelItemes = testLevelsDataEN.map((level, id) => {
    return (
      <TestLevelsSelectorItem titleEN={level.titleEN} descriptionEN={level.descriptionEN} titleRU={level.titleRU} descriptionRU={level.descriptionRU} key={id} />
    );
  });
